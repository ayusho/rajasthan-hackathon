  ...
  $.mbflipText= {
    ...
    flipText:function(tb){
      ...
      return this.each(function(){
        ...
        var fontsize= parseInt(el.css('font-size'))>0?parseInt(el.css('font-size')):12;
        ...
        if ($.browser.msie){
          ...
          label=$("<object class='flip_label' style='height:"+h+"px; width:"+w+"px;' type='image/svg+xml' data='data:image/svg+xml; charset=utf-8 ," +
                  ...
                  "<text  x=\"-"+xFix+"\" y=\""+yFix+"\"   fill=\""+fontcolor+"\" font-size=\""+fontsize+"\"  style=\"text-anchor: "+ta+"; " +
                  "dominant-baseline: hanging\" transform=\"rotate("+rot+")\" text-rendering=\"optimizeSpeed\">Recently Closed Variables</text></svg>'></object>" +
                  clickScript +
                  "");
        }
